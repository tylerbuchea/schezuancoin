Schezuancoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/schezuancoin/files/Schezuancoin/schezuancoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Schezuancoin
...
New/changed settings (command-line or schezuancoin.conf file)
--------------------------------------------------------
