Schezuancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/schezuancoin/files/Schezuancoin/schezuancoin-0.5.4/
...
http://gitorious.org/schezuancoin/schezuancoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Schezuancoin-Qt notifications under Growl 1.3.
Increase required age of Schezuancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSchezuancoin properly when installing Schezuancoin-Qt over it. (Windows)
