...
#ifndef SCHEZUANCOIN_QT_SENDCOINSDIALOG_H
#define SCHEZUANCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending schezuancoins */
...
#endif // SCHEZUANCOIN_QT_SENDCOINSDIALOG_H
