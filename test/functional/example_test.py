...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SchezuancoinTestFramework
    pass

class ExampleTest(SchezuancoinTestFramework):
    # Each functional test is a subclass of the SchezuancoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SchezuancoinTestFramework class so other tests can use it."""
