...
# TestNode: A peer we use to send messages to schezuancoind, and store responses.
...
class CompactBlocksTest(SchezuancoinTestFramework):
    ...
    # This test actually causes schezuancoind to (reasonably!) disconnect us, so do this last.
    ...
    # schezuancoind's choice of nonce.
    ...
    # Test that schezuancoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for schezuancoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # schezuancoind will not send blocktxn responses for blocks whose height is
