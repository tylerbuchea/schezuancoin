...
#include "qt/schezuancoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SchezuancoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_schezuancoin-qt -platform xcb      # Linux
//     src/qt/test/test_schezuancoin-qt -platform windows  # Windows
//     src/qt/test/test_schezuancoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SchezuancoinUnits::formatWithUnit(unit, balance, false, SchezuancoinUnits::separatorAlways);
    ...
    // Amount input
    SchezuancoinAmountField* amountInput = receiveCoinsDialog.findChild<SchezuancoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: schezuancoin:")) != -1);
