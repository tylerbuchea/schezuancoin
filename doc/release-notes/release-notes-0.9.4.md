Schezuancoin Core version 0.9.4 is now available from:

  https://schezuancoin.org/bin/0.9.4/
...
this update is incompatible with the Schezuancoin system and could lead to consensus
forks.

Schezuancoin Core released binaries from https://schezuancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~schezuancoin/+archive/ubuntu/schezuancoin
- A third-party or self-compiled Schezuancoin Core

upgrade to Schezuancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
