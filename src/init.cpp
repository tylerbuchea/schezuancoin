 ...
 * between schezuancoind, and schezuancoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("schezuancoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SCHEZUANCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/schezuancoin/schezuancoin>";
    const std::string URL_WEBSITE = "<https://schezuancoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("schezuancoin-loadblk");
...
/** Sanity checks
 *  Ensure that Schezuancoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Schezuancoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Schezuancoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", SCHEZUANCOIN_CONF_FILENAME)).string());
