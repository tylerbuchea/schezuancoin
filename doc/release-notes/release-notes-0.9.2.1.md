Schezuancoin Core version 0.9.2.1 is now available from:

  https://schezuancoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SZC to 0.01 SZC
...
- Fix "Start schezuancoin on system login"
