Schezuancoin Core version 0.13.2 is now available from:

  <https://schezuancoin.org/bin/schezuancoin-core-0.13.2/>
...
- #8908 `4a974b2` Update schezuancoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow schezuancoin-tx to create v2 transactions (szcdrak)
