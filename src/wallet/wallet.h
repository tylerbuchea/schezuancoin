...
#ifndef SCHEZUANCOIN_WALLET_WALLET_H
#define SCHEZUANCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this schezuancoin node, and set to 0 for transactions that were created
...
#endif // SCHEZUANCOIN_WALLET_WALLET_H
