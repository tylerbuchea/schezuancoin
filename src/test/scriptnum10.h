...
#ifndef SCHEZUANCOIN_TEST_SCRIPTNUM10_H
#define SCHEZUANCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Schezuancoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SCHEZUANCOIN_TEST_BIGNUM_H
