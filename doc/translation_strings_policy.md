...
This document provides guidelines for internationalization of the Schezuancoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `schezuancoin_en.ts` remains unchanged.
