...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/schezuancoin/schezuancoin/pull/10340, but that change has been
    // postponed until after https://github.com/schezuancoin/schezuancoin/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-schezuancoin-address
 ...
 * https://schezuancointalk.org/?topic=54527, or
 * https://github.com/schezuancoin/schezuancoin/pull/1393.
 */
