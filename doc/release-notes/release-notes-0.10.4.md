Schezuancoin Core version 0.10.4 is now available from:

  <https://schezuancoin.org/bin/schezuancoin-core-0.10.4/>
...
- #6953 `43c2789` Split schezuancoin-tx into its own package
- #6953 `dfe0d4d` Include schezuancoin-tx binary on Debian/Ubuntu
