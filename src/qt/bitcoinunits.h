...
#ifndef SCHEZUANCOIN_QT_SCHEZUANCOINUNITS_H
#define SCHEZUANCOIN_QT_SCHEZUANCOINUNITS_H
...
/** Schezuancoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SchezuancoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SchezuancoinUnits(QObject *parent);

    /** Schezuancoin units.
      @note Source: https://en.schezuancoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SZC,
...
typedef SchezuancoinUnits::Unit SchezuancoinUnit;

#endif // SCHEZUANCOIN_QT_SCHEZUANCOINUNITS_H
