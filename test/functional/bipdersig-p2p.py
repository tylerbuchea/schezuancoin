...
class BIP66Test(SchezuancoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # schezuancoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and schezuancoind produces more specific reject
            # reasons.
